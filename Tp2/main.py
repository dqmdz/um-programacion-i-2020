...
def main():
    ...
    c=Cajero_automatico() 
    c.agregar_dinero([cien, doscientos, doscientos, mil, doscientos, quinientos, mil, mil, mil,  cien, cien, cien, cien, cien, cien, cien, cien, mil, quinientos, quinientos, quinientos, doscientos, cien, cien, cien, quinientos, cien])  
