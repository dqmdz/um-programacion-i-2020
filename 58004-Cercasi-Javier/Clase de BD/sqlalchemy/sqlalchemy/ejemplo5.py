...
class DBCon:
    def __init__(self):
        ...
        # SQLite
        str_conexion = 'sqlite:///javito.db'
        self.engine = create_engine(str_conexion, echo=False, connect_args={"check_same_thread": False})
        ...
        # str_conexion = 'mysql+pymysql://javi:javi@192.168.10.106:3306/sqlalchemy'
        # str_conexion = 'mysql+pymysql://javi:javi@localhost:3306/sqlalchemy'
